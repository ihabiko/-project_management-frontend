      ...
      <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-9 col-lg-10">
                <div class="page-header">
                  ...
                  <div class="d-flex align-items-center">
                    <ul class="avatars">
                      ...
                      <li>
                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Marcus Simmons">
                          <img alt="Marcus Simmons" class="avatar" src="assets/img/avatar-male-1.jpg">
                        </a>
                      </li>

                      <li>
                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Peggy Brown">
                          <img alt="Peggy Brown" class="avatar" src="assets/img/avatar-female-2.jpg">
                        </a>
                      </li>

                      <li>
                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Harry Xai">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade active show" id="task" role="tabpanel">
                    <div class="content-list" data-filter-list="checklist">
                      <div class="row content-list-head">
                        <div class="col-auto">
                          <h3>Checklist</h3>
                          <button class="btn btn-round" data-toggle="tooltip" data-title="New item" data-original-title="" title="">
                            <i class="material-icons">add</i>
                          </button>
                        </div>
                      ...
                      <div class="content-list-body">
                        <form class="checklist filter-list-1626159688592" tabindex="0"><div class="row" tabindex="0">
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Create boards in Matboard" data-filter-by="value" style="width: 217px;" class="filter-by-value">
                            ...
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Invite team to boards" data-filter-by="value" class="filter-by-value" style="width: 176px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Identify three distinct aesthetic styles for boards" data-filter-by="value" class="filter-by-value" style="width: 392px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Add aesthetic style descriptions as notes" data-filter-by="value" class="filter-by-value" style="width: 332px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                            <!--end of form group-->
                          </div><div class="row" tabindex="0" style="">
                            <div class="form-group col">
                              <span class="checklist-reorder">
                                <i class="material-icons">reorder</i>
                              </span>
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Assemble boards using inspiration from Dribbble, Land Book, Nicely Done etc." data-filter-by="value" class="filter-by-value" style="width: 629px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Gather feedback from project team" data-filter-by="value" class="filter-by-value" style="width: 287px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group col">
                              ...
                              <div class="custom-control custom-checkbox col">
                                ...
                                <div>
                                  <input type="text" placeholder="Checklist item" value="Invite clients to board before next concept meeting" data-filter-by="value" class="filter-by-value" style="width: 415px;">
                                  <div class="checklist-strikethrough"></div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="content-list" data-filter-list="content-list-body">
                      ...
                      <!--end of content list head-->
                      <div class="content-list-body filter-list-1626159688588"><div class="card card-note">
                  ...
                  <div class="tab-pane fade" id="files" role="tabpanel" data-filter-list="dropzone-previews">
                    <div class="content-list">
                      ...
                      <div class="content-list-body">
                        ...
                        <form class="dropzone dz-clickable" action="https://mediumra.re/dropzone/upload.php">
                          <span class="dz-message">Drop files here or click here to upload</span>
                        </form>

                        <ul class="list-group list-group-activity dropzone-previews flex-column-reverse filter-list-1626159688583"><li class="list-group-item" data-t="null" data-i="null" data-l="null" data-e="null">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                <li>
                  ...
                  <div class="tab-pane fade" id="activity" role="tabpanel" data-filter-list="list-group-activity">
                    <div class="content-list">
                      ...
                      <!--end of content list head-->
                      <div class="content-list-body">
                        <ol class="list-group list-group-activity filter-list-1626159688574"><li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                <li>
                                  <div class="avatar bg-primary">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="users-manage" data-filter-list="form-group-users">
                          ...
                          <div class="form-group-users filter-list-1626159688570"><div class="custom-control custom-checkbox">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane fade" id="task-edit-members" role="tabpanel">
                            <div class="users-manage" data-filter-list="form-group-users">
                              ...
                              <div class="form-group-users filter-list-1626159688555"><div class="custom-control custom-checkbox">
                ...
                <form class="modal fade" id="note-add-modal" tabindex="-1" style="display: none;" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
